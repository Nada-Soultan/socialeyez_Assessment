  ...
  var getOptions = function getOptions() {
    return {
      ...
      data: {
        datasets: [{
          data: [5, 3],
          backgroundColor: [utils.rgbaColor(utils.getColor('Expenses'), 0.2), utils.rgbaColor(utils.getColor('Revenues'), 0.2)],
          borderWidth: 1,
          borderColor: [utils.getColor('Expenses'), utils.getColor('Revenues')]
        }],
